...
int main(int argc, char* argv[])
{
	...
	unsigned local_dnp32 = 2;
	unsigned local_dnp3  = 1;
	string   local_ip    = "127.0.0.1";
	unsigned local_port  = 5000;
	int option = 0;
...
//	stackConfig2.link.LocalAddr = local_dnp32;
//	stackConfig2.link.RemoteAddr = remote_dnp3;
