...
TransportStackPair::TransportStackPair(
	...
	mClient(apLogger->GetSubLogger("TCPClient"), apService, TcpSettings("127.0.0.1", aPort)),
	mServer(apLogger->GetSubLogger("TCPServer"), apService, TcpSettings("127.0.0.1", aPort)),
