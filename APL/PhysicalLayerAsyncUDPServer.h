...
#ifndef __PHYSICAL_LAYER_ASYNC_UDP_SERVER_H_
#define __PHYSICAL_LAYER_ASYNC_UDP_SERVER_H_
...
namespace apl {
	...
	class PhysicalLayerAsyncUDPServer : public PhysicalLayerAsyncBaseUDP
	{
		public:
			PhysicalLayerAsyncUDPServer(Logger*, boost::asio::io_service* apIOService, const std::string& arEndpoint, boost::uint16_t aPort, bool aBroadcast);

			virtual ~PhysicalLayerAsyncUDPServer();
		...
		private:
			...
			// boost::asio::ip::udp::acceptor mAcceptor;
