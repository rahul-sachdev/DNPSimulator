...
// under the License.
//
#ifndef __ASYNC_UDP_TEST_OBJECT_H_
#define __ASYNC_UDP_TEST_OBJECT_H_

#include <APLTestTools/AsyncTestObjectASIO.h>

#include <APLTestTools/LogTester.h>
#include <APL/PhysicalLayerAsyncUDPClient.h>
#include <APL/PhysicalLayerAsyncUDPServer.h>
...
namespace apl {
	...
	class AsyncUDPTestObject : public AsyncTestObjectASIO, public LogTester
	{
		public:
			AsyncUDPTestObject(FilterLevel aLevel = LEV_INFO, bool aImmediate = false, bool aAutoRead = true);
			virtual ~AsyncUDPTestObject();
