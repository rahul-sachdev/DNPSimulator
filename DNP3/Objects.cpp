...
namespace apl { namespace dnp {
	...
	void Group2Var2::Write(boost::uint8_t* p, const apl::Binary& v) const { DNPToStream::WriteQT(p, Group2Var2::Inst(), v); }
	void Group2Var3::Write(boost::uint8_t* p, const apl::Binary& v) const { DNPToStream::WriteQT(p, Group2Var3::Inst(), v); }

	Binary Group1Var2::Read(const boost::uint8_t* p) const { return DNPFromStream::ReadBinaryQV(p, Group1Var2::Inst()); }
	...
	Counter Group20Var3::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group20Var3::Inst()); }
	Counter Group20Var4::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group20Var4::Inst()); }
	Counter Group20Var5::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadV(apPos, Group20Var5::Inst()); }
	Counter Group20Var6::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadV(apPos, Group20Var6::Inst()); }
	Counter Group20Var7::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadV(apPos, Group20Var7::Inst()); }
	Counter Group20Var8::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadV(apPos, Group20Var8::Inst()); }

	void Group20Var1::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQV(apPos, Group20Var1::Inst(), v); }
	void Group20Var2::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQV(apPos, Group20Var2::Inst(), v); }
	void Group20Var3::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQV(apPos, Group20Var3::Inst(), v); }
	void Group20Var4::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQV(apPos, Group20Var4::Inst(), v); }
	void Group20Var5::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteV(apPos, Group20Var5::Inst(), v); }
	void Group20Var6::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteV(apPos, Group20Var6::Inst(), v); }
	void Group20Var7::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteV(apPos, Group20Var7::Inst(), v); }
	void Group20Var8::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteV(apPos, Group20Var8::Inst(), v); }

	Counter Group22Var1::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group22Var1::Inst()); }
	Counter Group22Var2::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group22Var2::Inst()); }
	Counter Group22Var3::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group22Var3::Inst()); }
	Counter Group22Var4::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group22Var4::Inst()); }
	Counter Group22Var5::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQVT(apPos, Group22Var5::Inst()); }
	Counter Group22Var6::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQVT(apPos, Group22Var6::Inst()); }
	Counter Group22Var7::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQVT(apPos, Group22Var7::Inst()); }
	Counter Group22Var8::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQVT(apPos, Group22Var8::Inst()); }

	void Group22Var1::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQV(apPos, Group22Var1::Inst(), v); }
	void Group22Var2::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQV(apPos, Group22Var2::Inst(), v); }
	void Group22Var3::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQV(apPos, Group22Var3::Inst(), v); }
	void Group22Var4::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQV(apPos, Group22Var4::Inst(), v); }
	void Group22Var5::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQVT(apPos, Group22Var5::Inst(), v); }
	void Group22Var6::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQVT(apPos, Group22Var6::Inst(), v); }
	void Group22Var7::Write(boost::uint8_t* apPos, const apl::Counter& v) const { DNPToStream::WriteQVT(apPos, Group22Var7::Inst(), v); }
	...
	void Group30Var4::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteV(p, Group30Var4::Inst(), v); }
	void Group30Var5::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteCheckRangeQV(p, Group30Var5::Inst(), v); }
	void Group30Var6::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteCheckRangeQV(p, Group30Var6::Inst(), v); }

	Analog Group30Var1::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group30Var1::Inst()); }
	Analog Group30Var2::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group30Var2::Inst()); }
	Analog Group30Var3::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadV(apPos, Group30Var3::Inst()); }
	Analog Group30Var4::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadV(apPos, Group30Var4::Inst()); }
	Analog Group30Var5::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group30Var5::Inst()); }
	Analog Group30Var6::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group30Var6::Inst()); }

	void Group32Var1::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteCheckRangeQV(p, Group32Var1::Inst(), v); }
	void Group32Var2::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteCheckRangeQV(p, Group32Var2::Inst(), v); }
	void Group32Var3::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteCheckRangeQVT(p, Group32Var3::Inst(), v); }
	void Group32Var4::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteCheckRangeQVT(p, Group32Var4::Inst(), v); }
	void Group32Var5::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteQV(p, Group32Var5::Inst(), v); }
	void Group32Var6::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteQV(p, Group32Var6::Inst(), v); }
	void Group32Var7::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteQVT(p, Group32Var7::Inst(), v); }
	void Group32Var8::Write(boost::uint8_t* p, const apl::Analog& v) const { DNPToStream::WriteQVT(p, Group32Var8::Inst(), v); }

	Analog Group32Var1::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group32Var1::Inst()); }
	Analog Group32Var2::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group32Var2::Inst()); }
	Analog Group32Var3::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQVT(apPos, Group32Var3::Inst()); }
	Analog Group32Var4::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQVT(apPos, Group32Var4::Inst()); }
	Analog Group32Var5::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group32Var5::Inst()); }
	...
	SetpointStatus Group40Var3::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group40Var3::Inst()); }
	SetpointStatus Group40Var4::Read(const boost::uint8_t* apPos) const { return DNPFromStream::ReadQV(apPos, Group40Var4::Inst()); }

	void Group40Var1::Write(boost::uint8_t* apPos, const apl::SetpointStatus& arObj) const { DNPToStream::WriteQV(apPos, Group40Var1::Inst(), arObj); }
	void Group40Var2::Write(boost::uint8_t* apPos, const apl::SetpointStatus& arObj) const { DNPToStream::WriteQV(apPos, Group40Var2::Inst(), arObj); }
	...
	void Group41Var2::Write(boost::uint8_t* apBuff, const Setpoint& arVal) const
	{
	...
	apl::CopyableBuffer Group41Var2::GetValueBytes(const boost::uint8_t* apBuff) const
	{
		return CopyableBuffer(apBuff, 2);
	}

	void Group41Var3::Write(boost::uint8_t* apBuff, const Setpoint& arVal) const
	{
	...
	apl::CopyableBuffer Group41Var3::GetValueBytes(const boost::uint8_t* apBuff) const
	{
		return CopyableBuffer(apBuff, 4);
	}
	...
	apl::CopyableBuffer Group41Var4::GetValueBytes(const boost::uint8_t* apBuff) const
	{
