...
namespace apl {  namespace dnp {
	...
	class LinkLayer : public ILowerLayer, public ILinkContext
	{
		...
		void ResetReadFCB() { mNextReadFCB = true; }
		void ToggleReadFCB() { mNextReadFCB = !mNextReadFCB; }
		bool NextReadFCB() { return mNextReadFCB; }

		void ResetWriteFCB() { mNextWriteFCB = true; }
		void ToggleWriteFCB() { mNextWriteFCB = !mNextWriteFCB; }
		bool NextWriteFCB() { return mNextWriteFCB; }
		...
		void ResetRetry();
		bool Retry();
		size_t RetryRemaining() { return mRetryRemaining; }
